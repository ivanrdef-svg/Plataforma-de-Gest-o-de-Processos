...
import type { ProcessSection } from "@/lib/process-store";

/**
 * Build 006 — bloco de seção do Processo.
 * Mesmo padrão de autoria do POP Builder: cada seção é independente,
 * expande/recolhe e edita título, conteúdo e observações.
 */
...
export function ProcessSectionBlock({
  ...
  open: boolean;
  onToggle: () => void;
  onChange: (patch: Partial<ProcessSection>) => void;
}) {
  return (
    <section
    ...
    >
      <div className="flex items-start gap-2 px-4 py-3">
        ...
        <span className="mt-1 shrink-0 tabular-nums text-[10px] text-muted-foreground/70">
      ...
      {open && (
        <div className="space-y-4 border-t px-4 py-4 pl-12">
          <AutoTextarea
          ...
          <div className="rounded-lg bg-muted/50 px-3 py-2">
            ...
            <AutoTextarea
              ...
              placeholder="Notas internas, pendências, decisões…"
